-- Clear users table and create 5 demo profiles
-- Run these queries in your Supabase SQL editor

-- 1. Clear existing users (be careful with this in production!)
DELETE FROM users;

-- 2. Insert 5 demo profiles with unique phone numbers and data
INSERT INTO users (
  id,
  name,
  age,
